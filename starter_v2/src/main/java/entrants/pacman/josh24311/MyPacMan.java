...
public class MyPacMan extends PacmanController 
{
    ...
    public MOVE getMove(Game game, long timeDue)
    {
        ...
        if(ambush_stat) //在埋伏狀態
        {
        	System.out.println("ambush now");
        	
        	if(minDistanceGh<=D[0]) /*r3*/
        	{
        	...
        	System.out.println("remain ambush point");
        	return game.getNextMoveTowardsTarget(current, closehnode, Constants.DM.PATH);
        }
        /*r5*/
        if(!targets.isEmpty()&&minGhost!=null) //還有PP且至少一隻不可食鬼
        {
        	if(minEdGhost==null)
        	{
        ...
        /*r9*/
        if(minEdGhost!=null&&minGhost!=null) //有兩種狀態的鬼
        {
